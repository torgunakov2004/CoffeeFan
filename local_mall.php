            ...
            <div class="header">
                ...
                <div class="header-action">
                    <a href="local_mall.php">
                        <button class="header-action__cart-1 material-icons-outlined active">shopping_cart</button>
                    </a>
                    <nav class="profile">
                        <nav class="account">
                        ...
                        <?php else: ?>
                            <ul class="submenu">
                                ...
                                if (isset($_SESSION['user']['is_admin']) && $_SESSION['user']['is_admin']) $isAdmin = true;
                                if ($isAdmin):
                                ?>
                                    <li class="menu-divider"></li>
