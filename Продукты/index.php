            ...
            <div class="header">
                <nav class="nav-main">
                    <ul class="nav-main__list">
                        ...
                        <li class="nav-main__item"><a class="nav-main__link nav-main__link_selected" href="#">Продукты</a></li>
                                ...
                                <div class="popular__flick-container">
                                    <div class="popular__content-wrapper">
                                        <div class="popular__image-side">
                                            <img class="popular__img" src="<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['title'] ?? 'Товар') ?>">
                                        </div>
