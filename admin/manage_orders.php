                ...
                <table class="admin-table orders-table" id="ordersTable">
                    <thead>
                        <tr>
                            ...
                            <th class="sortable" data-sort="items_count" data-sort-type="number">Кол-во товаров</th>
                    ...
                    <tbody id="ordersTableBody">
                        <?php foreach ($orders_data as $order): ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><?php echo htmlspecialchars($order['items_count']); ?></td>
    ...
    $ordersTable.find('th.sortable').on('click', function() {
        ...
        rows.sort(function(a, b) {
            ...
            if (type === 'number') {
                ...
                if (column === 'order_id') { // Убираем '#' для сортировки ID
