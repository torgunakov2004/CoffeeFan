         ...
         <div class="container">
             <div class="footer">
                 ...
                 <ul class="footer__list">
                     ...
                     <li class="footer__item"><a class="footer__link" href="#">Рецепты</a></li> <!-- Текущая страница -->
                     <li class="footer__item"><a class="footer__link" href="../Продукты/index.php">Продукты</a></li>
                     <?php /* <li class="footer__item"><a class="footer__link" href="../Меню/index.php">Меню</a></li> Ссылки на меню не было в вашем исходном футере продуктов */ ?>
